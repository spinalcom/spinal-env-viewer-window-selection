...
EventsEmitter.Composer(window.Autodesk.Viewing.Extension) {
  ...
  initializeEvents() {
    ...
    this.viewerEvents = [{
        id: window.Autodesk.Viewing.EXTENSION_LOADED_EVENT,
        handler: 'onExtensionLoaded'
      },
      {
        id: window.Autodesk.Viewing.OBJECT_TREE_CREATED_EVENT,
        handler: 'onObjectTreeCreated'
      },
      {
        id: window.Autodesk.Viewing.MODEL_ROOT_LOADED_EVENT,
      ...
      {
        id: window.Autodesk.Viewing.GEOMETRY_LOADED_EVENT,
        handler: 'onGeometryLoaded'
      },
      {
        id: window.Autodesk.Viewing.TOOLBAR_CREATED_EVENT,
        handler: 'onToolbarCreated'
      },
      {
        id: window.Autodesk.Viewing.AGGREGATE_SELECTION_CHANGED_EVENT,
        handler: 'onSelection'
      }
    ]
